...
public class SecurityRoleRefImpl implements SecurityRoleRef {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityRoleRef#getRoleName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityRoleRef#getRoleLink()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityRoleRef#setRoleLink(String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityRoleRef#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityRoleRef#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityRoleRef#addDescription(com.liferay.plutonium.container.om.portlet.Description)
    */
   @Override
