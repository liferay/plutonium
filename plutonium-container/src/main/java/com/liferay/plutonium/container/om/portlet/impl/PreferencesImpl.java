...
public class PreferencesImpl implements Preferences {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.Preferences#getPortletPreference(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.Preferences#getPortletPreferences()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.Preferences#addPreference(com.liferay.plutonium.container.om.portlet.Preference)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.Preferences#getPreferencesValidator()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.Preferences#setPreferencesValidator(java.lang.String)
    */
   @Override
