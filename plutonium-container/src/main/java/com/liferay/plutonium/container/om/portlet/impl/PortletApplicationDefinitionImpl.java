...
public class PortletApplicationDefinitionImpl implements
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#getName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#setName(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#getContextPath()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#setContextPath(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#getVersion()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#setVersion(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#getResourceBundle()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#setResourceBundle(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#getDefaultNamespace()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletApplicationDefinition#setDefaultNamespace(java.lang.String)
    */
   @Override
