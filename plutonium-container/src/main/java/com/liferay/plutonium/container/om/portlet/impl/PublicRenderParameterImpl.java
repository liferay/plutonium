...
public class PublicRenderParameterImpl implements PublicRenderParameter {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#getQName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#getIdentifier()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#addDescription(com.liferay.plutonium.container.om.portlet.Description)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#getDisplayName(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#getDisplayNames()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#addDisplayName(com.liferay.plutonium.container.om.portlet.DisplayName)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#getAliases()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PublicRenderParameter#addAlias(javax.xml.namespace.QName)
    */
   @Override
