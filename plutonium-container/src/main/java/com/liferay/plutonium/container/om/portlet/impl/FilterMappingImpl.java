...
public class FilterMappingImpl implements FilterMapping {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.FilterMapping#getFilterName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.FilterMapping#getPortletNames()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.FilterMapping#addPortletName(java.lang.String)
    */
   @Override
