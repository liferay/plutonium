...
public class InitParamImpl implements InitParam {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.InitParam#getParamName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.InitParam#getParamValue()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.InitParam#setParamValue(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.InitParam#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.InitParam#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.InitParam#addDescription(com.liferay.plutonium.container.om.portlet.Description)
    */
   @Override
