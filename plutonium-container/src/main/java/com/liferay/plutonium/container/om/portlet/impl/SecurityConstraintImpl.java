...
public class SecurityConstraintImpl implements SecurityConstraint {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityConstraint#getUserDataConstraint()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityConstraint#getDisplayName(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityConstraint#getDisplayNames()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityConstraint#addDisplayName(com.liferay.plutonium.container.om.portlet.DisplayName)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityConstraint#getPortletNames()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.SecurityConstraint#addPortletName(java.lang.String)
    */
   @Override
