...
import com.liferay.plutonium.container.om.portlet40.impl.ContainerRuntimeOptionType;
import com.liferay.plutonium.container.om.portlet40.impl.CustomPortletModeType;
import com.liferay.plutonium.container.om.portlet40.impl.CustomWindowStateType;
import com.liferay.plutonium.container.om.portlet40.impl.DependencyType;
import com.liferay.plutonium.container.om.portlet40.impl.DescriptionType;
import com.liferay.plutonium.container.om.portlet40.impl.DisplayNameType;
import com.liferay.plutonium.container.om.portlet40.impl.EventDefinitionReferenceType;
import com.liferay.plutonium.container.om.portlet40.impl.EventDefinitionType;
import com.liferay.plutonium.container.om.portlet40.impl.FilterMappingType;
import com.liferay.plutonium.container.om.portlet40.impl.FilterType;
import com.liferay.plutonium.container.om.portlet40.impl.InitParamType;
import com.liferay.plutonium.container.om.portlet40.impl.KeywordsType;
import com.liferay.plutonium.container.om.portlet40.impl.ListenerType;
import com.liferay.plutonium.container.om.portlet40.impl.MimeTypeType;
import com.liferay.plutonium.container.om.portlet40.impl.MultipartType;
import com.liferay.plutonium.container.om.portlet40.impl.PortletAppType;
import com.liferay.plutonium.container.om.portlet40.impl.PortletInfoType;
import com.liferay.plutonium.container.om.portlet40.impl.PortletModeType;
import com.liferay.plutonium.container.om.portlet40.impl.PortletNameType;
import com.liferay.plutonium.container.om.portlet40.impl.PortletPreferencesType;
import com.liferay.plutonium.container.om.portlet40.impl.PortletType;
import com.liferay.plutonium.container.om.portlet40.impl.PreferenceType;
import com.liferay.plutonium.container.om.portlet40.impl.PublicRenderParameterType;
import com.liferay.plutonium.container.om.portlet40.impl.RoleLinkType;
import com.liferay.plutonium.container.om.portlet40.impl.SecurityRoleRefType;
import com.liferay.plutonium.container.om.portlet40.impl.ShortTitleType;
import com.liferay.plutonium.container.om.portlet40.impl.SupportedLocaleType;
import com.liferay.plutonium.container.om.portlet40.impl.SupportsType;
import com.liferay.plutonium.container.om.portlet40.impl.TitleType;
import com.liferay.plutonium.container.om.portlet40.impl.UserAttributeType;
import com.liferay.plutonium.container.om.portlet40.impl.ValueType;
import com.liferay.plutonium.container.om.portlet40.impl.WindowStateType;
...
/**
 * Processes configuration for Jakarta portlet app.
 * 
 * @author Scott Nicklous
 * 
 */
public class JakartaConfigurationProcessor extends JSR286ConfigurationProcessor {

   /** Logger. */
   private static final Logger                      LOG            = LoggerFactory
                                                                         .getLogger(
																			 JakartaConfigurationProcessor.class);
   ...
   public JakartaConfigurationProcessor(PortletApplicationDefinition pad) {
      super(pad);
   }
    ...
    * (non-Javadoc)
    * 
    * @see JakartaConfigurationProcessor#process(JAXBElement);
    */
   @Override
   public void process(JAXBElement<?> rootElement) throws IllegalArgumentException {
      ...
      if ((app.getVersion() == null) || !app.getVersion().equals("4.0")) {
         String warning = "Bad version. Expected 4.0, was: " + app.getVersion();
         LOG.warn(warning);
   ...
   /**
    * validate the v4.0 configuration
    */
   ...
   public void processPortletAppAnnotation(PortletApplication app) {
      ...
      // version
      if (!app.version().equals("4.0")) {
         String warning = "Bad version in annotation. Expected 4.0, was: " + app.version();
         LOG.warn(warning);
         throw new IllegalArgumentException(warning);
      }
      ...
      for (UserAttribute ua : app.userAttributes()) {
         com.liferay.plutonium.container.om.portlet.UserAttribute attrib = new UserAttributeImpl(ua.name());
      ...
      for (jakarta.portlet.annotations.CustomPortletMode cpm : app.customPortletModes()) {
         CustomPortletMode mode = new CustomPortletModeImpl(cpm.name());
      ...
      for (jakarta.portlet.annotations.CustomWindowState cpm : app.customWindowStates()) {
         CustomWindowState ws = new CustomWindowStateImpl(cpm.name());
         for (LocaleString ls : cpm.description()) {
            Description d = new DescriptionImpl(Locale.forLanguageTag(ls.locale()), ls.value());
            ws.addDescription(d);
         }
