...
import com.liferay.plutonium.container.bean.processor.MethodAnnotationRecognizer;
...
public class ConfigurationHolder {
   ...
   private static final String          JAXB_CONTEXT = "com.liferay.plutonium.container.om.portlet10.impl:"
                                                           ...
                                                           + "com.liferay.plutonium.container.om.portlet40.impl"; // LOH
   ...
   public void processPortletDD(InputStream stream) throws IOException, IllegalArgumentException, JAXBException,
      ...
      if (jel.getValue() instanceof com.liferay.plutonium.container.om.portlet10.impl.PortletAppType) {
      ...
      } else if (jel.getValue() instanceof com.liferay.plutonium.container.om.portlet20.impl.PortletAppType) {

         // Ignore existing config data for 2.0 portlets
         pad = new PortletApplicationDefinitionImpl();
         jcp = new JSR286ConfigurationProcessor(pad);

      } else if (jel.getValue() instanceof com.liferay.plutonium.container.om.portlet30.impl.PortletAppType) {
      ...
      } else if (jel.getValue() instanceof com.liferay.plutonium.container.om.portlet40.impl.PortletAppType) {
