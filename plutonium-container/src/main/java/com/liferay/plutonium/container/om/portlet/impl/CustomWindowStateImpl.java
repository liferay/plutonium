...
public class CustomWindowStateImpl implements CustomWindowState {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.CustomWindowState#getWindowState()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.CustomWindowState#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.CustomWindowState#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.CustomWindowState#addDescription(Description)
    */
   @Override
