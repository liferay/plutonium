...
public class UserAttributeImpl implements UserAttribute {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.UserAttribute#getUserAttributeName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.UserAttribute#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.UserAttribute#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.UserAttribute#addDescription(com.liferay.plutonium.container.om.portlet.Description)
    */
   @Override
