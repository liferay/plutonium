...
import com.liferay.plutonium.container.om.portlet30.impl.ContainerRuntimeOptionType;
import com.liferay.plutonium.container.om.portlet30.impl.CustomPortletModeType;
import com.liferay.plutonium.container.om.portlet30.impl.CustomWindowStateType;
import com.liferay.plutonium.container.om.portlet30.impl.DependencyType;
import com.liferay.plutonium.container.om.portlet30.impl.DescriptionType;
import com.liferay.plutonium.container.om.portlet30.impl.DisplayNameType;
import com.liferay.plutonium.container.om.portlet30.impl.EventDefinitionReferenceType;
import com.liferay.plutonium.container.om.portlet30.impl.EventDefinitionType;
import com.liferay.plutonium.container.om.portlet30.impl.FilterMappingType;
import com.liferay.plutonium.container.om.portlet30.impl.FilterType;
import com.liferay.plutonium.container.om.portlet30.impl.InitParamType;
import com.liferay.plutonium.container.om.portlet30.impl.KeywordsType;
import com.liferay.plutonium.container.om.portlet30.impl.ListenerType;
import com.liferay.plutonium.container.om.portlet30.impl.MimeTypeType;
import com.liferay.plutonium.container.om.portlet30.impl.MultipartType;
import com.liferay.plutonium.container.om.portlet30.impl.PortletAppType;
import com.liferay.plutonium.container.om.portlet30.impl.PortletInfoType;
import com.liferay.plutonium.container.om.portlet30.impl.PortletModeType;
import com.liferay.plutonium.container.om.portlet30.impl.PortletNameType;
import com.liferay.plutonium.container.om.portlet30.impl.PortletPreferencesType;
import com.liferay.plutonium.container.om.portlet30.impl.PortletType;
import com.liferay.plutonium.container.om.portlet30.impl.PreferenceType;
import com.liferay.plutonium.container.om.portlet30.impl.PublicRenderParameterType;
import com.liferay.plutonium.container.om.portlet30.impl.RoleLinkType;
import com.liferay.plutonium.container.om.portlet30.impl.SecurityRoleRefType;
import com.liferay.plutonium.container.om.portlet30.impl.ShortTitleType;
import com.liferay.plutonium.container.om.portlet30.impl.SupportedLocaleType;
import com.liferay.plutonium.container.om.portlet30.impl.SupportsType;
import com.liferay.plutonium.container.om.portlet30.impl.TitleType;
import com.liferay.plutonium.container.om.portlet30.impl.UserAttributeType;
import com.liferay.plutonium.container.om.portlet30.impl.ValueType;
import com.liferay.plutonium.container.om.portlet30.impl.WindowStateType;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Processes configuration for JSR 362 portlet app.
 * 
...
public class JSR362ConfigurationProcessor extends JSR286ConfigurationProcessor {
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.plutonium.container.om.portlet.impl.jsr362.ConfigurationProcessor #process(jakarta.xml.bind.JAXBElement)
    */
   @Override
   ...
   public void processPortletAppAnnotation(PortletApplication app) {
      ...
      for (jakarta.portlet.annotations.CustomPortletMode cpm : app.customPortletModes()) {
         com.liferay.plutonium.container.om.portlet.CustomPortletMode mode = new CustomPortletModeImpl(cpm.name());
      ...
      for (jakarta.portlet.annotations.CustomWindowState cpm : app.customWindowStates()) {
         com.liferay.plutonium.container.om.portlet.CustomWindowState ws = new CustomWindowStateImpl(cpm.name());
         for (LocaleString ls : cpm.description()) {
            Description d = new DescriptionImpl(Locale.forLanguageTag(ls.locale()), ls.value());
            ws.addDescription(d);
         }
