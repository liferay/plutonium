...
public class PortletInfoImpl implements PortletInfo {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletInfo#getTitle()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletInfo#setTitle(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#getTitle(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#getTitles()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#addTitle(com.liferay.plutonium.container.om.portlet.LocaleText)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletInfo#getKeywords()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletInfo#setKeywords(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#getKeywordsList(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#getKeywords()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#addKeywords(com.liferay.plutonium.container.om.portlet.LocaleText)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletInfo#getShortTitle()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletInfo#setShortTitle(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#getShortTitle(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#getShortTitles()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.container.om.portlet.PortletDefinition#addShortTitle(com.liferay.plutonium.container.om.portlet.LocaleText)
    */
   @Override
