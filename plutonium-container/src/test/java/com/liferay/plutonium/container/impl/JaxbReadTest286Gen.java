...
public class JaxbReadTest286Gen {
   ...
   private static final String XML_FILE     = "com/liferay/plutonium/container/om/portlet/portlet286Generated.xml";
   ...
   public void portlet286Generated() throws Exception {
      ...
      assertEquals("com.liferay.plutonium.container.om.portlet.impl.fixtures.TestEventType", portletApp.getEventDefinition().get(0).getValueType());
      ...
      assertEquals("com.liferay.plutonium.container.om.portlet.GoodBundle", portletApp.getResourceBundle().getValue());
