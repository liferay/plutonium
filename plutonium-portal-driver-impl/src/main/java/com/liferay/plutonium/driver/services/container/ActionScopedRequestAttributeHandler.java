...
import static com.liferay.plutonium.driver.url.PortalURLParameter.PARAM_TYPE_RENDER;
...
public class ActionScopedRequestAttributeHandler {
   ...
   static {
      ...
      try {
         configBundle = ResourceBundle.getBundle("com.liferay.plutonium.driver.services.container.ActionScopedRequestAttributeHandler");
      } catch (Throwable t) {
