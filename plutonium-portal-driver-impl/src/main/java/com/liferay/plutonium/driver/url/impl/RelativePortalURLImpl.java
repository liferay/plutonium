 ...
 */
package com.liferay.plutonium.driver.url.impl;

import static com.liferay.plutonium.driver.url.PortalURLParameter.PARAM_TYPE_PUBLIC;
import static com.liferay.plutonium.driver.url.PortalURLParameter.PARAM_TYPE_RESOURCE;
...
public class RelativePortalURLImpl implements PortalURL {
    ...
    * @see PortalURLParserImpl#toString(com.liferay.plutonium.driver.url.PortalURL)
    */
    ...
    * 
    * @see
    * com.liferay.plutonium.driver.url.PortalURL#setType(com.liferay.plutonium.driver.
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.plutonium.driver.url.PortalURL#getType()
    */
    ...
    * 
    * @see
    * com.liferay.plutonium.driver.url.PortalURL#setTargetWindow(java.lang.String)
    */
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.plutonium.driver.url.PortalURL#getTargetWindow()
    */
    ...
    * 
    * @see
    * com.liferay.plutonium.driver.url.PortalURL#clearResourceParameters(java.lang
    * .String)
    */
