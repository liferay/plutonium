...
import com.liferay.plutonium.driver.services.portal.PageResources;
...
//    private final Map portletApplications;
    ...
    public void initialized() {
       ...
       if (defaultPageResources.isEmpty()) {
          defaultPageResources.add(new PageResourceId("plutonium.css", "com.liferay.plutonium", "3.0.0"));
          defaultPageResources.add(new PageResourceId("portlet-spec-1.0.css", "com.liferay.plutonium", "1.0.0"));
          defaultPageResources.add(new PageResourceId("portlet-spec-2.0.css", "com.liferay.plutonium", "2.0.0"));
          defaultPageResources.add(new PageResourceId("plutonium.js", "com.liferay.plutonium", "3.0.0"));
       }
