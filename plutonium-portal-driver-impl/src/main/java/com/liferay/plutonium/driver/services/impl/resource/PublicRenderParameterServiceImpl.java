...
import com.liferay.plutonium.driver.services.portal.PublicRenderParameterQNameMapper;
...
public class PublicRenderParameterServiceImpl implements PublicRenderParameterService {
   ...
   /* (non-Javadoc)
    * @see com.liferay.plutonium.driver.services.portal.PublicRenderParameterService#getPRPMapper(java.lang.String)
    */
