 ...
 */
package com.liferay.pluto.driver.url.impl;

import static com.liferay.pluto.driver.url.PortalURLParameter.PARAM_TYPE_PUBLIC;
import static com.liferay.pluto.driver.url.PortalURLParameter.PARAM_TYPE_RESOURCE;
...
public class RelativePortalURLImpl implements PortalURL {
    ...
    * @see PortalURLParserImpl#toString(com.liferay.pluto.driver.url.PortalURL)
    */
    ...
    * 
    * @see
    * com.liferay.pluto.driver.url.PortalURL#setType(com.liferay.pluto.driver.
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.driver.url.PortalURL#getType()
    */
    ...
    * 
    * @see
    * com.liferay.pluto.driver.url.PortalURL#setTargetWindow(java.lang.String)
    */
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.driver.url.PortalURL#getTargetWindow()
    */
    ...
    * 
    * @see
    * com.liferay.pluto.driver.url.PortalURL#clearResourceParameters(java.lang
    * .String)
    */
