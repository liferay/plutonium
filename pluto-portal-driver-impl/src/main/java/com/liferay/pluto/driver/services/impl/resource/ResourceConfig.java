...
import com.liferay.pluto.driver.services.portal.PropertyConfigService;
import com.liferay.pluto.driver.services.portal.RenderConfig;
...
//    private final Map portletApplications;
    ...
    public void initialized() {
       ...
       if (defaultPageResources.isEmpty()) {
          defaultPageResources.add(new PageResourceId("pluto.css", "com.liferay.pluto", "3.0.0"));
          defaultPageResources.add(new PageResourceId("portlet-spec-1.0.css", "com.liferay.pluto", "1.0.0"));
          defaultPageResources.add(new PageResourceId("portlet-spec-2.0.css", "com.liferay.pluto", "2.0.0"));
          defaultPageResources.add(new PageResourceId("pluto.js", "com.liferay.pluto", "3.0.0"));
       }
