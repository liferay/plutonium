...
import static com.liferay.pluto.driver.url.PortalURLParameter.PARAM_TYPE_RENDER;
...
public class ActionScopedRequestAttributeHandler {
   ...
   static {
      ...
      try {
         configBundle = ResourceBundle.getBundle("com.liferay.pluto.driver.services.container.ActionScopedRequestAttributeHandler");
      } catch (Throwable t) {
