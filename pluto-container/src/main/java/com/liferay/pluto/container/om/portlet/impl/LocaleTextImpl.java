...
public class LocaleTextImpl implements LocaleText {
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Text#getLang()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Text#getText()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Text#setText(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Text#getLocale()
    */
   @Override
