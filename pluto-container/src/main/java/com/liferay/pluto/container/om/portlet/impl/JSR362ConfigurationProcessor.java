...
import com.liferay.pluto.container.om.portlet30.impl.ContainerRuntimeOptionType;
import com.liferay.pluto.container.om.portlet30.impl.CustomPortletModeType;
import com.liferay.pluto.container.om.portlet30.impl.CustomWindowStateType;
import com.liferay.pluto.container.om.portlet30.impl.DependencyType;
import com.liferay.pluto.container.om.portlet30.impl.DescriptionType;
import com.liferay.pluto.container.om.portlet30.impl.DisplayNameType;
import com.liferay.pluto.container.om.portlet30.impl.EventDefinitionReferenceType;
import com.liferay.pluto.container.om.portlet30.impl.EventDefinitionType;
import com.liferay.pluto.container.om.portlet30.impl.FilterMappingType;
import com.liferay.pluto.container.om.portlet30.impl.FilterType;
import com.liferay.pluto.container.om.portlet30.impl.InitParamType;
import com.liferay.pluto.container.om.portlet30.impl.KeywordsType;
import com.liferay.pluto.container.om.portlet30.impl.ListenerType;
import com.liferay.pluto.container.om.portlet30.impl.MimeTypeType;
import com.liferay.pluto.container.om.portlet30.impl.MultipartType;
import com.liferay.pluto.container.om.portlet30.impl.PortletAppType;
import com.liferay.pluto.container.om.portlet30.impl.PortletInfoType;
import com.liferay.pluto.container.om.portlet30.impl.PortletModeType;
import com.liferay.pluto.container.om.portlet30.impl.PortletNameType;
import com.liferay.pluto.container.om.portlet30.impl.PortletPreferencesType;
import com.liferay.pluto.container.om.portlet30.impl.PortletType;
import com.liferay.pluto.container.om.portlet30.impl.PreferenceType;
import com.liferay.pluto.container.om.portlet30.impl.PublicRenderParameterType;
import com.liferay.pluto.container.om.portlet30.impl.RoleLinkType;
import com.liferay.pluto.container.om.portlet30.impl.SecurityRoleRefType;
import com.liferay.pluto.container.om.portlet30.impl.ShortTitleType;
import com.liferay.pluto.container.om.portlet30.impl.SupportedLocaleType;
import com.liferay.pluto.container.om.portlet30.impl.SupportsType;
import com.liferay.pluto.container.om.portlet30.impl.TitleType;
import com.liferay.pluto.container.om.portlet30.impl.UserAttributeType;
import com.liferay.pluto.container.om.portlet30.impl.ValueType;
import com.liferay.pluto.container.om.portlet30.impl.WindowStateType;
...
public class JSR362ConfigurationProcessor extends JSR286ConfigurationProcessor {
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.impl.jsr362.ConfigurationProcessor #process(jakarta.xml.bind.JAXBElement)
    */
   @Override
   ...
   public void processPortletAppAnnotation(PortletApplication app) {
      ...
      for (jakarta.portlet.annotations.CustomPortletMode cpm : app.customPortletModes()) {
         com.liferay.pluto.container.om.portlet.CustomPortletMode mode = new CustomPortletModeImpl(cpm.name());
      ...
      for (jakarta.portlet.annotations.CustomWindowState cpm : app.customWindowStates()) {
         com.liferay.pluto.container.om.portlet.CustomWindowState ws = new CustomWindowStateImpl(cpm.name());
         for (LocaleString ls : cpm.description()) {
            Description d = new DescriptionImpl(Locale.forLanguageTag(ls.locale()), ls.value());
            ws.addDescription(d);
         }
