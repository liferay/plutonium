...
public class SupportsImpl implements Supports {
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Supports#getMimeType()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Supports#setMimeType(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Supports#getPortletModes()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Supports#addPortletMode(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Supports#getWindowStates()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Supports#addWindowState(java.lang.String)
    */
   @Override
