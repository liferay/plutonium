...
public class PortletDefinitionImpl implements PortletDefinition {
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getPortletName()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getApplication()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getInitParam(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getInitParams()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addInitParam(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getPortletClass()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#setPortletClass(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getPortletInfo()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getPortletPreferences()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSupportedProcessingEvents()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addSupportedProcessingEvent(EventDefinitionReference)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSupportedPublishingEvents()
    */
   @Override
    ...
    * 
    * @see
    * com.liferay.pluto.container.om.portlet.PortletDefinition#addSupportedPublishingEvent(javax.xml.namespace.QName)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSupportedPublicRenderParameters()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addSupportedPublicRenderParameter(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getResourceBundle()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#setResourceBundle(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSecurityRoleRef(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSecurityRoleRefs()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addSecurityRoleRef(SecurityRoleRef)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSupports(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSupports()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addSupports(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getConfiguredMimeTypes()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#isPortletModeSupported(String, PrtletMode)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getDependency(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getDependency()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addDependency(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getDescription(java.util.Locale)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getDescriptions()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addDescription(com.liferay.pluto.container.om.portlet.
    * Description)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getDisplayName(java.util.Locale)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getDisplayNames()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addDisplayName(com.liferay.pluto.container.om.portlet.
    * DisplayName)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getSupportedLocales()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addSupportedLocale(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getExpirationCache()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#setExpirationCache(int)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getCacheScope()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#setCacheScope(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getContainerRuntimeOption(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#getContainerRuntimeOptions()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.liferay.pluto.container.om.portlet.PortletDefinition#addContainerRuntimeOption(java.lang.String)
    */
   @Override
