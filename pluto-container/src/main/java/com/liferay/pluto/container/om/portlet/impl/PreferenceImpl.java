...
public class PreferenceImpl implements Preference {
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Preference#getName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Preference#getValues()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Preference#addValue(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Preference#isReadOnly()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Preference#setReadOnly(boolean)
    */
   @Override
