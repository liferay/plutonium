...
public class CustomPortletModeImpl implements CustomPortletMode {
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.CustomPortletMode#getPortletMode()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.CustomPortletMode#isPortalManaged()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.CustomPortletMode#setPortalManaged(boolean)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.CustomPortletMode#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.CustomPortletMode#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.CustomPortletMode#addDescription(Description)
    */
   @Override
