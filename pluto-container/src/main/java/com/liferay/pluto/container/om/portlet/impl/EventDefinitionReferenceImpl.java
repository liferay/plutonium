...
public class EventDefinitionReferenceImpl implements EventDefinitionReference {
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinitionReference#getQualifiedName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinitionReference#setQualifiedName(javax.xml.namespace.QName)
    */
   @Override
