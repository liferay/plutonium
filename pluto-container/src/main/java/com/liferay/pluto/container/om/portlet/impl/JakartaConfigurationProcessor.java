...
import com.liferay.pluto.container.om.portlet40.impl.ContainerRuntimeOptionType;
import com.liferay.pluto.container.om.portlet40.impl.CustomPortletModeType;
import com.liferay.pluto.container.om.portlet40.impl.CustomWindowStateType;
import com.liferay.pluto.container.om.portlet40.impl.DependencyType;
import com.liferay.pluto.container.om.portlet40.impl.DescriptionType;
import com.liferay.pluto.container.om.portlet40.impl.DisplayNameType;
import com.liferay.pluto.container.om.portlet40.impl.EventDefinitionReferenceType;
import com.liferay.pluto.container.om.portlet40.impl.EventDefinitionType;
import com.liferay.pluto.container.om.portlet40.impl.FilterMappingType;
import com.liferay.pluto.container.om.portlet40.impl.FilterType;
import com.liferay.pluto.container.om.portlet40.impl.InitParamType;
import com.liferay.pluto.container.om.portlet40.impl.KeywordsType;
import com.liferay.pluto.container.om.portlet40.impl.ListenerType;
import com.liferay.pluto.container.om.portlet40.impl.MimeTypeType;
import com.liferay.pluto.container.om.portlet40.impl.MultipartType;
import com.liferay.pluto.container.om.portlet40.impl.PortletAppType;
import com.liferay.pluto.container.om.portlet40.impl.PortletInfoType;
import com.liferay.pluto.container.om.portlet40.impl.PortletModeType;
import com.liferay.pluto.container.om.portlet40.impl.PortletNameType;
import com.liferay.pluto.container.om.portlet40.impl.PortletPreferencesType;
import com.liferay.pluto.container.om.portlet40.impl.PortletType;
import com.liferay.pluto.container.om.portlet40.impl.PreferenceType;
import com.liferay.pluto.container.om.portlet40.impl.PublicRenderParameterType;
import com.liferay.pluto.container.om.portlet40.impl.RoleLinkType;
import com.liferay.pluto.container.om.portlet40.impl.SecurityRoleRefType;
import com.liferay.pluto.container.om.portlet40.impl.ShortTitleType;
import com.liferay.pluto.container.om.portlet40.impl.SupportedLocaleType;
import com.liferay.pluto.container.om.portlet40.impl.SupportsType;
import com.liferay.pluto.container.om.portlet40.impl.TitleType;
import com.liferay.pluto.container.om.portlet40.impl.UserAttributeType;
import com.liferay.pluto.container.om.portlet40.impl.ValueType;
import com.liferay.pluto.container.om.portlet40.impl.WindowStateType;
...
public class JakartaConfigurationProcessor extends JSR286ConfigurationProcessor {
   ...
   public void processPortletAppAnnotation(PortletApplication app) {
      ...
      for (UserAttribute ua : app.userAttributes()) {
         com.liferay.pluto.container.om.portlet.UserAttribute attrib = new UserAttributeImpl(ua.name());
