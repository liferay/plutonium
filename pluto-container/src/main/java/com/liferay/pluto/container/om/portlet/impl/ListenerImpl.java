...
public class ListenerImpl implements Listener {
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#addDescription(com.liferay.pluto.container.om.portlet.Description)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#getDisplayName(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#getDisplayNames()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#addDisplayName(com.liferay.pluto.container.om.portlet.DisplayName)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#getListenerClass()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.Listener#setListenerClass(java.lang.String)
    */
   @Override
