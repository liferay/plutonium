...
public class EventDefinitionImpl implements EventDefinition {
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#getQName()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#setQName(javax.xml.namespace.QName)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#getAliases()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#addAlias(javax.xml.namespace.QName)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#getDescription(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#getDescriptions()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#addDescription(com.liferay.pluto.container.om.portlet.Description)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#getDisplayName(java.util.Locale)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#getDisplayNames()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#addDisplayName(com.liferay.pluto.container.om.portlet.DisplayName)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#getValueType()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.liferay.pluto.container.om.portlet.EventDefinition#setValueType(java.lang.String)
    */
   @Override
