...
also persist these changes to plutonium-portal-driver-config.xml in plutonium's WEB-INF directory.
</p>
...
plutonium:assemble goal in maven-plutonium-plugin) or Ant (AssembleTask).
...
<p class="portlet-font">
The plutonium-portal-driver-config.xml file holds changes made by the Page Administrator Portlet. You can manually
...
the new theme. Use the default theme (/WEB-INF/themes/plutonium-default-theme.jsp in the plutonium webapp) for
