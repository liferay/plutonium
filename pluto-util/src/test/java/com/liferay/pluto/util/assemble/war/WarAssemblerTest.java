...
import com.liferay.pluto.util.assemble.ArchiveBasedAssemblyTest;
...
public class WarAssemblerTest extends ArchiveBasedAssemblyTest {
    ...
    private static final String portletResourceNoManifest = "/com/liferay/pluto/util/assemble/war/WarDeployerTestPortletNoManifest.war";
    private static final String portletResource = "/com/liferay/pluto/util/assemble/war/WarDeployerTestPortlet.war";
