...
public class AssemblyStreamTest extends TestCase {
    ...
    private static final String webXmlToAssembleResource = "/com/liferay/pluto/util/assemble/file/web.xml";
    private static final String portletXmlResource = "/com/liferay/pluto/util/assemble/file/portlet.xml";
    private static final String warToAssembleResource = "/com/liferay/pluto/util/assemble/war/WarDeployerTestPortlet.war";
