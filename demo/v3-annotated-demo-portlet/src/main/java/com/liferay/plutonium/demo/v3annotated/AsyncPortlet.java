...
import com.liferay.plutonium.demo.v3annotated.AsyncDialogBean.OutputType;
...
public class AsyncPortlet {
   ...
   public static void trace(ResourceRequest req, String src) {
      if (isTrace) {
         ...
         txt.append("\nasync_request_uri:      ").append((String) req.getAttribute("jakarta.servlet.async.request_uri"));
         txt.append("\nasync_context_path:      ").append((String) req.getAttribute("jakarta.servlet.async.context_path"));
         txt.append("\nasync_servlet_path:      ").append((String) req.getAttribute("jakarta.servlet.async.servlet_path"));
         txt.append("\nasync_path_info:      ").append((String) req.getAttribute("jakarta.servlet.async.path_info"));
         txt.append("\nasync_query_string:      ").append((String) req.getAttribute("jakarta.servlet.async.query_string"));
         txt.append("\nforward_request_uri:      ").append((String) req.getAttribute("jakarta.servlet.forward.request_uri"));
         txt.append("\nforward_context_path:      ").append((String) req.getAttribute("jakarta.servlet.forward.context_path"));
         txt.append("\nforward_servlet_path:      ").append((String) req.getAttribute("jakarta.servlet.forward.servlet_path"));
         txt.append("\nforward_path_info:      ").append((String) req.getAttribute("jakarta.servlet.forward.path_info"));
         txt.append("\nforward_query_string:      ").append((String) req.getAttribute("jakarta.servlet.forward.query_string"));
         txt.append("\ninclude_request_uri:      ").append((String) req.getAttribute("jakarta.servlet.include.request_uri"));
         txt.append("\ninclude_context_path:      ").append((String) req.getAttribute("jakarta.servlet.include.context_path"));
         txt.append("\ninclude_servlet_path:      ").append((String) req.getAttribute("jakarta.servlet.include.servlet_path"));
         txt.append("\ninclude_path_info:      ").append((String) req.getAttribute("jakarta.servlet.include.path_info"));
         txt.append("\ninclude_query_string:      ").append((String) req.getAttribute("jakarta.servlet.include.query_string"));
