...
import static com.liferay.plutonium.demo.hub.Constants.PARAM_BORDER_COLOR;
import static com.liferay.plutonium.demo.hub.Constants.PARAM_COLOR;
import static com.liferay.plutonium.demo.hub.Constants.PARAM_IMGNAME;
import static com.liferay.plutonium.demo.hub.Constants.DEFAULT_IMAGE;
...
import static com.liferay.plutonium.demo.hub.Constants.IMG_MAP;
...
@PortletApplication(
      events = {
            @EventDefinition(
                  qname = @PortletQName(
                        namespaceURI = "http://www.apache.org/portals/plutonium/ResourcePortlet", 
                        localPart = "Message"),
