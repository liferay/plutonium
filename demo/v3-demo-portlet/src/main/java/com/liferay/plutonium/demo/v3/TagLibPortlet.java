...
@PortletApplication(events= {@EventDefinition(
      qname=@PortletQName(namespaceURI="http://www.apache.org/portals/plutonium", localPart="TagLibPortlet"),
...
public class TagLibPortlet {
   ...
   private static final String URI     = "http://www.apache.org/portals/plutonium";
   ...
   public void header(HeaderRequest req, HeaderResponse resp) throws IOException {
      ...
      resp.addDependency("infobox", "com.liferay.plutonium", "0.4.0", txt.toString());
