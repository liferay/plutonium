...
public class PortletConfigDemoIT extends DemoTestDriver {
   ...
   public void testPortletConfigDemo() {
      ...
      assertTextVisible("Public Render Parameters:",
            "Name: color, QName: {http://www.apache.org/portals/plutonium/pub-render-params/ResourcePortlet}alt-color",
            1);
      assertTextVisible("Public Render Parameters:",
            "Name: photo, QName: {http://www.apache.org/portals/plutonium/pub-render-params/ResourcePortlet}ph-imgName",
            1);
