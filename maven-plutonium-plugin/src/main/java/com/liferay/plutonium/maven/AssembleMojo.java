 ...
 *              &lt;artifactId&gt;maven-plutonium-plugin&lt;/artifactId&gt;
 *          &lt;/plugin&gt;
 *      &lt;/plugins&gt;
 *   &lt;/build&gt;
 *   ...
 ...
 * 
 * @since Jul 30, 2005
 * @see com.liferay.plutonium.util.assemble.Assembler
 * 
 * @goal assemble
...
public class AssembleMojo extends AbstractPortletMojo {
     ...
     * @parameter expression="${project.build.directory}/plutonium-resources/web.xml"
     */
     ...
     * @parameter alias="warFilesDestination" expression="${project.build.directory}/plutonium-assembled-wars"
     */
