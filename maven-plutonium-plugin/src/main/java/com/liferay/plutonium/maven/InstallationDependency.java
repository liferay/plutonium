...
class InstallationDependency {    
    ...
    public static final InstallationDependency CONTAINER_API =
        new InstallationDependency("com.liferay.plutonium", "plutonium-container-api",
                VERSION_PROPERTIES.getProperty("plutonium.version"));

    public static final InstallationDependency CONTAINER =
            new InstallationDependency("com.liferay.plutonium", "plutonium-container",
                    VERSION_PROPERTIES.getProperty("plutonium.version"));

    public static final InstallationDependency  TAGLIB =
            new InstallationDependency("com.liferay.plutonium", "plutonium-taglib",
                    VERSION_PROPERTIES.getProperty("plutonium.version"));

    public static final InstallationDependency CONTAINER_DRIVER_API =
        new InstallationDependency("com.liferay.plutonium", "plutonium-container-driver-api",
                VERSION_PROPERTIES.getProperty("plutonium.version"));

    public static final InstallationDependency PORTAL =
            new InstallationDependency("com.liferay.plutonium", "plutonium-portal",
                    VERSION_PROPERTIES.getProperty("plutonium.version"), "war");

    public static final InstallationDependency TESTSUITE =
            new InstallationDependency("com.liferay.plutonium", "plutonium-testsuite",
                    VERSION_PROPERTIES.getProperty("plutonium.version"), "war");
