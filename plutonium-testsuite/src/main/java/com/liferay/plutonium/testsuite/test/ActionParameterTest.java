...
public class ActionParameterTest extends AbstractReflectivePortletTest {
    ...
    public static final String KEY = "com.liferay.plutonium.testsuite.PARAM_ACTION_KEY";

    /** Parameter value encoded in the action URL. */
    public static final String VALUE = "com.liferay.plutonium.testsuite.ACTION_VALUE";
