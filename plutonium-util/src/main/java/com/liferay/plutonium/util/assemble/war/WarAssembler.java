...
import com.liferay.plutonium.util.assemble.AbstractArchiveAssembler;
import com.liferay.plutonium.util.assemble.AssemblerConfig;
import com.liferay.plutonium.util.assemble.io.JarStreamingAssembly;
...
public class WarAssembler extends AbstractArchiveAssembler {
    ...
    protected void assembleWar(File source, File dest, String dispatchServletClass) throws IOException {
        ...
        //TODO add plutonium notes to the Manifest?
