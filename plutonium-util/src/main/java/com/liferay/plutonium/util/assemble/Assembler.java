...
/**
 * The plutonium assembler is used to assemble a portlet application which is
 * deployable to plutonium.
 *
 * @version 1.0
 * @since Oct 15, 2004
 */
public interface Assembler {
     ...
     * deployable into the plutonium-1.1 portlet container. The specified web
