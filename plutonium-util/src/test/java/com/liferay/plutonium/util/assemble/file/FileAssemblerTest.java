...
import com.liferay.plutonium.util.assemble.ResourceEntityResolver;
...
public class FileAssemblerTest extends XMLTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        final URL webXmlUrl = this.getClass().getResource("/com/liferay/plutonium/util/assemble/file/web.xml");
        this.webXmlFile = new File(webXmlUrl.getFile());

        final URL web23XmlUrl = this.getClass().getResource("/com/liferay/plutonium/util/assemble/file/webServlet23.xml");
        this.web23XmlFile = new File(web23XmlUrl.getFile());

        final URL portletXmlUrl = this.getClass().getResource("/com/liferay/plutonium/util/assemble/file/portlet.xml");
        this.portletXmlFile = new File(portletXmlUrl.getFile());

        final URL portlet23XmlUrl = this.getClass().getResource("/com/liferay/plutonium/util/assemble/file/portletWebServlet23.xml");
        this.portlet23XmlFile = new File(portlet23XmlUrl.getFile());

        final URL assembledWebXmlUrl = this.getClass().getResource("/com/liferay/plutonium/util/assemble/file/assembled.web.xml");
        this.assembledWebXmlFile = new File(assembledWebXmlUrl.getFile());

        final URL assembledWeb23XmlUrl = this.getClass().getResource("/com/liferay/plutonium/util/assemble/file/assembled.webServlet23.xml");
