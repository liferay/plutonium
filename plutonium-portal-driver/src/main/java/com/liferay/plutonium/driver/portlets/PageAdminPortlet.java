...
import com.liferay.plutonium.driver.PortalDriverServlet;
...
public class PageAdminPortlet extends GenericPlutoniumPortlet {
    ...
    private static final String CONFIG_FILE_PATH = "/WEB-INF/plutonium-portal-driver-config.xml";
    ...
    /**
     * Persist page configuration changes to render-config section of plutonium-portal-driver-config.xml.
     * 
    ...
    private void persistPages() throws IOException {
    	...
    	renderConfig.append(NL);
    	renderConfig.append(NL);
    	renderConfig.append("</plutonium-portal-driver>");
    	renderConfig.append(NL);
    ...
    /**
     * Get the page name of the default page from plutonium-portal-driver-config.xml.
     * 
     * @return
     * @throws IOException
     */
     ...
     * 
     * @param contents plutonium-portal-driver-config.xml file contents.
     * @return
     */
    ...
    /**
     * Parse out default attribute value of render-config element in plutonium-portal-driver-config.xml. 
     * This method is protected to allow unit testing (see <code>PageAdminPortletTest.testParseDefaultPage()</code>.)
     * 
     * @param configFileContents Contents of plutonium-portal-driver-config.xml file.
