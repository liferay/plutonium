...
public class Configuration {
    ...
    public static final ResourceBundle BUNDLE =
        ResourceBundle.getBundle("com.liferay.plutonium.driver.container.plutonium-configuration");

    private static final String DESCRIPTOR_SERVICE =
        "com.liferay.plutonium.descriptors.services.PortletAppDescriptorService";

    private static final String CONTAINER_RUNTIME_OPTIONS =
        "com.liferay.plutonium.container.supportedContainerRuntimeOptions";

    /**
     * com.liferay.plutonium.PREVENT_UNECESSARY_CROSS_CONTEXT
     */
    private static final String PREVENT_UNECESSARY_CROSS_CONTEXT =
        "com.liferay.plutonium.PREVENT_UNECESSARY_CROSS_CONTEXT";

    /**
     * com.liferay.plutonium.ALLOW_BUFFER
     */
    ...
    public static final String getPortletContainerName() {
        return BUNDLE.getString("plutonium.container.name");
    }
    ...
    public static final String getPortletContainerVersion() {
        return BUNDLE.getString("plutonium.container.version");
    }
