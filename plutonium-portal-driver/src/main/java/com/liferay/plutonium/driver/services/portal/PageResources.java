...
public class PageResources {
   ...
   static {
      ...
      resid = new PageResourceId("plutonium.css", "com.liferay.plutonium", "3.0.0");
      src = new Source(Type.CSS, "/css/plutonium.css");
      defaultResources.put(resid, src);
      
      resid = new PageResourceId("portlet-spec-1.0.css", "com.liferay.plutonium", "1.0.0");
      src = new Source(Type.CSS, "/css/portlet-spec-1.0.css");
      defaultResources.put(resid, src);
      
      resid = new PageResourceId("portlet-spec-2.0.css", "com.liferay.plutonium", "2.0.0");
      src = new Source(Type.CSS, "/css/portlet-spec-2.0.css");
      defaultResources.put(resid, src);
      
      resid = new PageResourceId("plutonium.js", "com.liferay.plutonium", "3.0.0");
