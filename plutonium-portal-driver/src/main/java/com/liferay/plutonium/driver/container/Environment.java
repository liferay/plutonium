 ...
 * <code>environment.properties</code> file packaged with plutonium.
 */
final class Environment {

    /**
     * Properties Resource Bundle containing plutonium environment information.
     */
    public static final ResourceBundle PROPS;

    static {
        PROPS = ResourceBundle.getBundle("com.liferay.plutonium.environment");
    }
    ...
    public static final String getPortletContainerName() {
        return PROPS.getString("plutonium.container.name");
    }
    ...
    public static final String getPortletContainerVersion() {
        return PROPS.getString("plutonium.container.version");
    }
