...
public class PageResources {
   ...
   static {
      ...
      resid = new PageResourceId("pluto.css", "com.liferay.pluto", "3.0.0");
      src = new Source(Type.CSS, "/css/pluto.css");
      defaultResources.put(resid, src);
      
      resid = new PageResourceId("portlet-spec-1.0.css", "com.liferay.pluto", "1.0.0");
      src = new Source(Type.CSS, "/css/portlet-spec-1.0.css");
      defaultResources.put(resid, src);
      
      resid = new PageResourceId("portlet-spec-2.0.css", "com.liferay.pluto", "2.0.0");
      src = new Source(Type.CSS, "/css/portlet-spec-2.0.css");
      defaultResources.put(resid, src);
      
      resid = new PageResourceId("pluto.js", "com.liferay.pluto", "3.0.0");
